            ...
            <div class="col-lg-6">
              <div class="banner_content text-center">
                ...
                <div class="page_link">
                  ...
                  <a href="belanja.php">Lihat video lainnya</a>
                </div>
              </div>
            </div>
          </div>
            ...
            <div class="row">
                <div class="col-lg-8 course_details_left">
                    <div class="main_image">
                        <img src="img/<?php echo $video['sampul_video']; ?>" class="img-fluid rounded-start" alt="<?php echo $video['judul_video']; ?>" style="width:430px; height: 430px;">
                    </div>
                    <div class="content_wrapper">
                        <h4 class="title">Deskripsi Video</h4>
                        <div class="content">
                        <?php echo $video['keterangan_video']; ?>
                        </div>
                </div>
                </div>
                    ...
                    <ul>
                        <li>
                            <a class="justify-content-between d-flex " href="#">
                                <p>Judul Video</p>
                                <span class="or"><?php echo $video['judul_video']; ?></span>
                            </a>
                        </li>
                        <li>
                            <a class="justify-content-between d-flex" href="#">
                                <p>Harga Video</p>
                                <span class="text-danger"><?php echo $video['harga_video']; ?></span>
                            </a>
                        </li>
                    </ul>
                    <div class="text-right">
                      <a href="#" data-toggle=modal class="primary-btn ml-sm-1 ml-0" data-target=#modalbeli>
                        <i class="bi bi-plus"></i> Akses Video
                      </a>
                    </div>
                        ...
                        <div class="feedeback">
                            ...
                            <form action="submit_feedback.php" method="POST">
                                ...
                                <a href="belanja.php" class="primary-btn text-right rounded-0 bi-arrow-right">Daftar Video lainnya</a>
                            </div>
                        </div>
