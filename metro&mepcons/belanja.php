      ...
      <div class="container mt-4">
                ...
                <?php while ($row = mysqli_fetch_assoc($result_video)): ?>
                    <div class="col-md-4 mt-3">
                        <div class="single-defination">
                            <img src="img/<?php echo $row['sampul_video']; ?>" alt="<?php echo $row['judul_video']; ?>" style="width: 350px; height: 200px;" class="mb-2">
        ...
        <div class="row">
          <?php while ($row = mysqli_fetch_assoc($result_ebook)): ?>
            ...
            <div class="single-defination">
              <img src="img/<?php echo $row['sampul_ebook']; ?>" alt="<?php echo $row['judul_ebook']; ?>" style="width: 350px; height: 200px;" class="mb-2">
