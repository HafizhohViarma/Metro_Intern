...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (move_uploaded_file($bukti_bayar['tmp_name'], $upload_file)) {
        ...
        $query = "INSERT INTO tb_transaksi (id_user, nama_user, tipe_produk, tgl_transaksi, harga, bukti_bayar, payment, id_kelas)
                  VALUES ('$id_user', '$nama_user', '$tipe_produk', '$tanggal_transaksi', '$harga', '$upload_file', '$payment', '$id_kelas')";
